		...
		<div class="row">
			<div class="col-sm-8 col-md-9">
				<div class="panel panel-plain">
					<div class="panel-nav">
						<a href="<?=base_url('materi-mahasiswa')?>" class="panel-link"><i class="fa fa-chevron-left"></i> Kembali</a>
					</div>
					...
					<div class="panel-body">
						<form class="input-55" action="<?=base_url()?>submit-tambah-materi-mahasiswa" method="POST" enctype="multipart/form-data" accept-charset="utf-8" id="form-tambah-baru" onsubmit="return publishMateri(this);">
							<div class="row">
								<div class="col-md-5">
									<div class="form-group">
										<label for="">Nama Materi</label>
										<input type="text" name="nama" class="form-control" placeholder="Masukkan Nama Materi">
									</div>
								</div>
								<div class="col-md-7">
									<div class="form-group">
