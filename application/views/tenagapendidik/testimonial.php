				...
				<div class="content-filter-search">
					<div class="row">
						...
						<div class="col-sm-9 col-md-4 col-md-push-5 col-lg-push-0 col-lg-3">
							<a href="<?=base_url()?>testimonial-tambah-pendidik" class="btn btn-55 btn-success btn-block">Tambah Testimonial</a>
						</div>
					</div>
				</div>
								...
								<div class="panel-body">
									...
									<div class="row">
										...
										<div class="col-xs-12 col-sm-12 col-md-6 ci-right">
											<a href="<?=base_url()?>edit-testimonial-pendidik/<?=$value->id?>" class="btn btn-normal btn-plonk-yellow"><i class="bgicon icon-magic"></i> Edit</a>
											<a href="<?=base_url()?>hapus-testimonial-pendidik/<?=$value->id?>" class="btn btn-normal btn-plonk-red"><i class="bgicon icon-trash-empty"></i> Hapus</a>
										</div>
									</div>
								</div>
							</div>
