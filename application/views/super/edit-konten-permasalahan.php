		...
		<div class="row">
			<div class="col-sm-8 col-md-9">
				<div class="panel panel-plain">
					<div class="panel-nav">
						<a href="<?=base_url('kelola-konten-permasalahan')?>"><i class="fa fa-chevron-left"></i> Kembali</a>
					</div>
					...
					<div class="panel-body">
						<form action="<?=base_url()?>submit-edit-konten-permasalahan" class="input-55" method="POST">
							...
							<div class="form-group row">
								...
								<div class="col-sm-6 col-lg-push-4 col-lg-4">
									<label for="">&nbsp;</label>
									<button class="btn btn-55 btn-success btn-block" type="submit">Update <span class="hidden-sm">Pertanyaan</span></button>
								</div>
							</div>
						</form>
					</div>
